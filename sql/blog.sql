...
(
    ...
    `open_type`          int(1)      NOT NULL DEFAULT '1' COMMENT '是否开启文章类型',
...
(
    ...
    `authority` int(1)     NOT NULL COMMENT '用户权限，0为管理员',
    PRIMARY KEY (`id`)
...
(
    ...
    `year`       varchar(50) NOT NULL COMMENT '归档年份',
...
-- ----------------------------------------
INSERT INTO `t_user`(`id`, `username`, `password`, `email`, `authority`)
    VALUE (1,'admin',' 49ba59abbe56e057','1667191252@qq.com','0');
